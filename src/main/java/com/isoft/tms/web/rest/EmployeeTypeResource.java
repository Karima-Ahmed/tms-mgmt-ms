...
/**
 * REST controller for managing {@link com.isoft.tms.domain.EmployeeType}.
 */
@RestController
@RequestMapping("/api")
public class EmployeeTypeResource {
    ...
    private static final String ENTITY_NAME = "stuffMgmtMsEmployeeType";
    ...
    public ResponseEntity<List<EmployeeTypeDTO>> getAllEmployeeTypes(EmployeeTypeCriteria criteria, Pageable pageable) {
        log.debug("REST request to get EmployeeTypes by criteria: {}", criteria);
        Page<EmployeeTypeDTO> page = employeeTypeQueryService.findByCriteria(criteria, pageable);
